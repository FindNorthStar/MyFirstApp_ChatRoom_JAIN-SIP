package com.mycompany.myfirstapp.ua.impl;
...
import com.mycompany.myfirstapp.TransferMsg;
import com.mycompany.myfirstapp.ua.ISipEventListener;
import com.mycompany.myfirstapp.ua.ISipManager;
import com.mycompany.myfirstapp.ua.NotInitializedException;
import com.mycompany.myfirstapp.ua.SipManagerState;
import com.mycompany.myfirstapp.ua.SipProfile;
import com.mycompany.myfirstapp.ua.impl.msg.SipRequestMsgBuilder;
	...
	public void processRequest(RequestEvent arg0) {
		...
		if(request.getMethod().equals(Request.MESSAGE))//聊天信息和好友操作
		{
            ...
            if(contentHeader!=null&&(contentHeader.getContentSubType().equals("add")||
                    contentHeader.getContentSubType().equals("refuse")||
                    contentHeader.getContentSubType().equals("approve")))
            {
